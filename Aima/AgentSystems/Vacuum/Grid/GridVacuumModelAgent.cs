...
namespace Aima.AgentSystems.Vacuum.Grid
{
    public class GridVacuumModelAgent : ModelBasedReflexAgent<GridVacuumPerception, GridVacuumNonObservableState>
    {
        ...
        public GridVacuumModelAgent()
        {
            ...
            Rules.Add(new Rule<GridVacuumNonObservableState>(s => s.SelectedMovement == Direction.Left, VacuumActions.Left));
            Rules.Add(new Rule<GridVacuumNonObservableState>(s => s.SelectedMovement == Direction.Right, VacuumActions.Right));
            Rules.Add(new Rule<GridVacuumNonObservableState>(s => s.SelectedMovement == Direction.Up, VacuumActions.Up));
            Rules.Add(new Rule<GridVacuumNonObservableState>(s => s.SelectedMovement == Direction.Down, VacuumActions.Down));
        }

        public override GridVacuumNonObservableState UpdateState(GridVacuumNonObservableState lastState, IAction lastAction, GridVacuumPerception percept)
        {
